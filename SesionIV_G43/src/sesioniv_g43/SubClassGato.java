 ...
 * @author apmejiar
 */
public class SubClassGato extends MascotaClass{

    public SubClassGato(int codigo_mascota, String nombre, int nro_documento_dueño, String raza, char genero, LocalDate fecha_nacimiento, boolean desparacitado, boolean vacunas_al_dia, String tipo_alimento) {
        super(codigo_mascota, nombre, nro_documento_dueño, raza, genero, fecha_nacimiento, desparacitado, vacunas_al_dia, tipo_alimento);
    }

    
  
    public void consultar_info_gato(int codigo_mascota){
