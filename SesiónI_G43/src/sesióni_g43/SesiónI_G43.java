...
public class SesiónI_G43 {
    ...
    public static void main(String[] args) {
        ...
        //Validar que sea hombre mayor de edad y pertenezca al universo de marvel
        if (edad > 17 && universo_marvel == true && genero == 'M') {
            System.out.println(nombre_superheroe + " es un hombre mayor de edad y pertenece a Marvel");
        } else {
            System.out.println(nombre_superheroe + " no cumple alguna de las condiciones");
        }
    }
